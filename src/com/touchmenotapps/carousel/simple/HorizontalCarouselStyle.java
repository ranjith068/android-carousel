...
public class HorizontalCarouselStyle {
	...
	public static final int DIGIFLARE_CUSTOM = 5;
	 ...
	 *            - Application context
	 * @param style
	 *            - Pre-existing style to be applied.
	 */
	...
	private void setStyle(int style) {
		...
		case STYLE_LEFT_ALIGNED_ROTATION:
			...
			mTranslatateEnbabled = true;
			break;
		case DIGIFLARE_CUSTOM:
			mSpaceBetweenViews = 180 * dip;
			mRotation = 0;
			mRotationEnabled = false;
			mTranslate = 50;
			mCoverflowRotation = 0;
	...
	/**
	 * @param mCoverflowRotation
	 *            the mCoverflowRotation to set
	 */
	...
	/**
	 * @param mViewZoomOutFactor
	 *            the mViewZoomOutFactor to set
	 */
